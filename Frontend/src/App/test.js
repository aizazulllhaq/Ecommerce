...
let newProducts = products.map((p) => {
  let highlights = [
    "This is First Highlight for this product",
    "This is Second Highlight for this product",
    "This is Third Highlight for this product",
    "This is Fourth Highlight for this product",
  ];
  ...
  return {
    ...
    colors: colors,
    deleted: false,
    discountPrice: Math.floor(p.price * (1 - p.discountPercentage / 100)),
...
const jsonData = JSON.stringify(newProducts, null, 2);

fs.writeFileSync("newProducts.js", jsonData);
