...
const AdminAddProduct = () => {
  ...
  const handleDeleteProduct = (product) => {
    ...
    dispatch(deleteProductTemporaryAsync(deleteProduct));
    alert.success("Item Temporary Deleted");
    navigate("/admin");
  };

  const handleDeleteProductPermanantly = (product) => {
    dispatch(deleteProductPermanentlyAsync(product));
    alert.success("Item Permanently Deleted");
    navigate("/admin");
  };
  ...
  return (
    <>
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button
              ...
              className={`rounded-md ${
                product.deleted ? "bg-red-600" : "bg-gray-600"
              } px-3 py-2 text-sm font-semibold text-white shadow-sm hover:${
                product.deleted ? "bg-red-600" : "bg-gray-600"
              } focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
            >
              {product.deleted ? "Delete Permanently" : "Delete Temp"}
            </button>
      ...
      {product && (
        <Modal
          title={`${product.deleted ? "Permanantly" : "Temporary"} Delete ${
            product.title
          }`}
          ...
          dangerAction={() =>
            product.deleted
              ? handleDeleteProductPermanantly(product)
